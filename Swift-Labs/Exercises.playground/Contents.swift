...
// Add random nouns to the newString
let newValues = nounArray[index1] + nounArray[index2]
...
let characters = howManyCharacters.count
//: ### Exercise 4
...
// Print if the word contains tuna
...
// Replace all the ocurrences of like
